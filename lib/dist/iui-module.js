...
(function () {
  ...
  angular.module('iui.loadingIndicator', ['cgBusy']);
})();
'use strict';
...
(function () {
  ...
  angular.module('iui.loadingIndicator').directive('iuiLoadingLabel', ['$compile', '$q', function ($compile, $q) {
    var directive = {
      restrict: 'A',
      ...
      link: function link(scope, element, attrs) {
        ...
        var loadingLabel = function loadingLabel(newValue, oldValue) {
          var el;
          if (newValue) {
            element.empty();
...
(function (module) {
  ...
  module.run(['$templateCache', function ($templateCache) {
    $templateCache.put('/$iui-loading-indicator/iui-loading-label/iui-loading-label.html', '<section>\n' + '  {{loadingLabel.currentMessage}}\n' + '</section>');
  }]);
})();
'use strict';
